...
namespace ZenProgramming.Chakra.Core.Mocks.Data.Repositories
{
    ...
    public abstract class MockRepositoryRoot<TEntity, TScenarioInterface> : IRepository<TEntity>, IMockRepository
        ...
        where TScenarioInterface: IScenario
    {
        ...
        /// </summary>
        protected IDataSessionBase DataSession { get; }
		...
		protected MockRepositoryRoot(
            Func<IDataSessionBase> dataSession,
            Func<TScenarioInterface, IList<TEntity>> entitiesExpression)        
        {
            ...
            IScenario scenarioFromDataSession = (DataSession as IMockDataSessionBase).GetScenario();
    ...
    /// <typeparam name="TEntity">Type of entity</typeparam>
    /// <typeparam name="TScenarioInterface">Type of scenario interface (ex: IChakraScenario)</typeparam>
    public abstract class MockRepositoryBase<TEntity, TScenarioInterface> : MockRepositoryRoot<TEntity, TScenarioInterface>, IRepository<TEntity>, IMockRepository
        where TEntity : class, IEntity, new()
        where TScenarioInterface: IScenario
    {
		/// <summary>
