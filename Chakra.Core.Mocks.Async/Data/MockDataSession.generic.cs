...
namespace ZenProgramming.Chakra.Core.Mocks.Async.Data
{
    ...
    public class MockDataSessionAsync<TScenarioImplementation, TScenarioOption> : IMockDataSessionAsync<TScenarioImplementation, TScenarioOption>
        ...
        where TScenarioOption : class, IScenarioOption<TScenarioImplementation>, new()
    {
        ...
        /// </summary>
        public IDataTransactionAsync Transaction { get; private set; }
        ...
        public IDataTransactionAsync BeginTransaction()
        {
        ...
        public void SetActiveTransaction(IDataTransactionAsync dataTransaction)
        {
