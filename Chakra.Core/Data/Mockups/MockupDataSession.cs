...
namespace ZenProgramming.Chakra.Core.Data.Mockups
{
    ...
    /// </summary>
    public class MockupDataSession : IDataSession
    {
            ...
            where TRepositoryInterface : IRepository
        {
            ...
            return RepositoryHelper.Resolve<TRepositoryInterface, IMockupRepository>(this);
        }
        ...
        public IDataTransaction BeginTransaction()
        {
            ...
            var dataTransaction = new MockupDataTransaction(this);
